...
use Lite\Http\Middleware\CsrfMiddleware;
...
use Lite\Service\Provider\RequestServiceProvider;
...
class Lite
{
    ...
    {        
        ...
        $providers = [
            [ProviderTemplateEngineServiceProvider::class, ['request' => $request]],
            [DatabaseServiceProvider::class],
            [RouteServiceProvider::class, ['routes' => $routes->getRouteCollections()]],
            [RequestServiceProvider::class, ['request' => $request]]
        ];
        ...
        $middlewareStack->addMiddleware('auth', AuthMiddleware::class);
        $middlewareStack->addMiddleware('csrf', CsrfMiddleware::class, ['scope' => 'global']);
